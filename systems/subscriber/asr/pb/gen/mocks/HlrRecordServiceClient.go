...
import (
	...
	gen "github.com/ukama/ukama/systems/subscriber/asr/pb/gen"
	grpc "google.golang.org/grpc"

	mock "github.com/stretchr/testify/mock"
)

// HlrRecordServiceClient is an autogenerated mock type for the HlrRecordServiceClient type
type HlrRecordServiceClient struct {
	mock.Mock
}

// Activate provides a mock function with given fields: ctx, in, opts
func (_m *HlrRecordServiceClient) Activate(ctx context.Context, in *gen.ActivateReq, opts ...grpc.CallOption) (*gen.ActivateResp, error) {
...
func (_m *HlrRecordServiceClient) UpdateGuti(ctx context.Context, in *gen.UpdateGutiReq, opts ...grpc.CallOption) (*gen.UpdateGutiResp, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
...
func (_m *HlrRecordServiceClient) UpdatePackage(ctx context.Context, in *gen.UpdatePackageReq, opts ...grpc.CallOption) (*gen.UpdatePackageResp, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
...
func (_m *HlrRecordServiceClient) UpdateTai(ctx context.Context, in *gen.UpdateTaiReq, opts ...grpc.CallOption) (*gen.UpdateTaiResp, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
...
type mockConstructorTestingTNewHlrRecordServiceClient interface {
	mock.TestingT
	Cleanup(func())
}

// NewHlrRecordServiceClient creates a new instance of HlrRecordServiceClient. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
func NewHlrRecordServiceClient(t mockConstructorTestingTNewHlrRecordServiceClient) *HlrRecordServiceClient {
	mock := &HlrRecordServiceClient{}
	mock.Mock.Test(t)
